...
While the Stat Index makes use of Freebird, a small internal tool being created by [BBC R&D](http://www.bbc.co.uk/rd), it can more importantly be used to test and compare your own news - simply choose your URL and run it through Part 2 on HTML. If you're not a developer, journalist or researcher don't worry! A more friendly step-by-step workflow will soon be published online.
